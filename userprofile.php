                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-thumbnail" data-title="Product Name">
                                                        <a class="prd-thumb" href="single_product.php?status=singleproduct&&id=<?php echo $value['pdt_id'] ?>">
                                                            <figure><img width="113" height="113" src="admin/uploads/<?php echo $value['pdt_img'] ?>" alt="delivering cart"></figure>
                                                        </a>
                     ...
                     <form class="shopping-cart-form" action="#" method="POST">
                                        ...
                                        <!-- <tr class="cart_item wrap-buttons">
                                            <td>
                                                ...
                                                <h3 style="color: black;">delivering Address</h3>
                                            </td>
                                            <td colspan="3">


                                                <input type="text" style="border: none; width:100%" placeholder="input courier service and location" name="delivering" required>
                                            </td>
                    ...
                    <div class="col-md-3">
                        <div class="shpcart-subtotal-block">
                            ...
                            <b class="stt-name">Payment <span class="sub"></span></b> 
                                <input type="text" style="border: none; width:100%;" placeholder="Cash/Debit Card" name="txid" required>

                            </div>

                            <div style="margin-top: 25px;">
                            <b class="stt-name">Mobile <span class="sub"></span></b>  <br>
                                <input type="text" name="delivering_Mobile" class="form-control" value="<?php echo $_SESSION['mobile'] ?>" required>
                            </div>

                            <div style="margin-top: 25px;">
                            <b class="stt-name">delivery Address <span class="sub"></span></b>  <br>
                               <textarea name="delivering" class="form-control" id="" required> <?php echo $_SESSION['address'] ?> </textarea>
                            </div>
                            ...
                            <p class="pickup-info"><b>Free Pickup</b> is available as soon as today More about delivery and pickup</p>
                        </div>
                    </div>
                </div>
