...
<div class="header-middle biolife-sticky-object ">
    ...
    <?php while($logo = mysqli_fetch_assoc( $logo_info)) {
        ...
        ?>
                    <img src="assets/images/home/<?php echo $logo['img']; ?>" alt="biolife logo" width="135" height="36">
                                                ...
                                                <li>
                                                    <div class="minicart-item">
                                                        ...
                                                        <div class="left-info">
                                                            ...
                                                            <div class="price">
                                                                <ins><span class="price-amount"><span class="currencySymbol">Ugx. </span><?php echo $value['pdt_price'] ?></span></ins>
